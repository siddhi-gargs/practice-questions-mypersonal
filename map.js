...
const charCodesOf = function (char) {
...
const domainNamesOf = function (emails) {
  return emails.split("@").at(-1);
};
["user1@gmail.com", "admin@yahoo.com", "saloni@gmail", "www@world.com"].map(
  domainNamesOf
);
...
const wordLengthsOf = function (strings) {
  return strings.split(" ").map((chars) => {
    return chars.length;
  });
};
